...
//calculating the sha256 of a block of data

void sha256(void* data, size_t length, uint8_t output[32]){
	struct sha256_compute_data ctx;
	sha256_compute_data_init(&ctx);
